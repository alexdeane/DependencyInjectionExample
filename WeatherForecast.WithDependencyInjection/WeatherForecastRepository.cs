...
/// <summary>
/// We now can easily back our services with interfaces,
/// so the main controller (<see cref="AppController"/>) doesn't
/// need to be aware of implementation.
///
/// I could switch this out for a repository that reads from memory,
/// one that actually reads from a database, etc and never have
