...
/// <summary>
/// Just like the other things, we have an interface here now.
/// </summary>
public interface IWeatherForecastMappingService
{
...
/// </summary>
public class WeatherForecastMappingService : IWeatherForecastMappingService
{
    /// <summary>
